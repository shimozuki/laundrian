    ...
    <div class="row">
        <div class="col-12">
            <div class="card border rounded-0 h-100">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.customerUpdate', $customer->username) }}" enctype="multipart/form-data">
                        @csrf @method('PUT')
                        ...
                        <div class="d-flex justify-content-center align-items-center mb-0">
                            <a href="{{ route('admin.customer') }}" class="btn btn-secondary w-50 rounded-0 mb-0 me-3">KEMBALI</a>
