    ...
    <div class="row">
        <div class="col-12">
            <div class="card border rounded-0 h-100">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.customer') }}" class="d-flex justify-content-between mb-3">
                                            ...
                                            <td>
                                                <div class="ms-4">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end min-w-auto border rounded-0" aria-labelledby="actionDropdown">
                                                        ...
                                                        <li>
                                                            <form method="POST" id="delete-form-{{ $row->username }}" action="{{ route('admin.customerDestroy', $row->username) }}">
                                                                @csrf @method('DELETE')
                                                ...
                                                <div class="modal fade" id="customerUpdateModal-{{ $row->username }}" tabindex="-1" aria-labelledby="customerUpdateModallabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                                        <div class="modal-content border rounded-0">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" action="{{ route('admin.customerUpdate', $row->username) }}" enctype="multipart/form-data">
                                                                    @csrf @method('PUT')
    ...
    <div class="modal fade" id="customerModal" tabindex="-1" aria-labelledby="customerModallabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content border rounded-0">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('admin.customerStore') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row px-xxl-2">
                            <div class="col-12">
                                <label for="name" class="fw-medium small h6">NAMA</label>
