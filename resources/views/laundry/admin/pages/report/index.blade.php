    ...
    <div class="row">
        <div class="col-12">
            <div class="card border rounded-0 h-100">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.report') }}" class="d-flex justify-content-between align-items-center mb-3">
...
<script>
    $(document).ready(function() {
        ...
        $('#date').daterangepicker({
            ...
            $('#exportpdf').attr('href', '/admin/report/pdf/' + formatDateForLink(first) + '+' + formatDateForLink(last));
        });

        $('#exportpdf').attr('href', '/admin/report/pdf/' + formatDateForLink(start) + '+' + formatDateForLink(end));
    });
    </script>
@endsection
