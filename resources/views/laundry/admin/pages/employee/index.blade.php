...
@section('active-page-employee', 'active')

@section('content')
    <div class="row">
        <div class="col-12 mb-4 mb-sm-5">
            <div class="d-flex justify-content-between align-items-center">
                <span class="fw-medium h4 mb-0">KARYAWAN'S</span>
                <button type="button" class="btn btn-dark w-100px rounded-0" data-bs-toggle="modal" data-bs-target="#employeeModal">TAMBAH</button>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card border rounded-0 h-100">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.employee') }}" class="d-flex justify-content-between mb-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-shrink table-borderless align-middle mb-0">
                            ...
                            <tbody class="border-top-0">
                                @if (count($employee) > 0)
                                    @php
                                        $pageNumber = ($employee->currentPage() - 1) * $employee->perPage();
                                    @endphp
                                            ...
                                            <td>
                                                <div class="ms-4">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end min-w-auto border rounded-0" aria-labelledby="actionDropdown">
                                                        <li class="mb-1">
                                                            <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#employeeUpdateModal-{{ $row->username }}">
                                                        ...
                                                        <li>
                                                            <form method="POST" id="delete-form-{{ $row->username }}" action="{{ route('admin.employeeDestroy', $row->username) }}">
                                                                @csrf @method('DELETE')
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                                        <div class="modal-content border rounded-0">
                                                            <div class="modal-header border-0">
                                                                <span class="fw-normal text-center h5 mb-0">RINCIAN KARYAWAN</span>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <div class="row px-xxl-2 mb-3">
                                                                    <div class="col-md-4">
                                                                        <div class="card card-element-hover card-overlay-hover overflow-hidden rounded-0">
                                                                            <img src="{{ asset('storage/profiles/'. $row->image) }}" alt="avatar" class="avatar-img bg-light shadow rounded-0">
                                                                            <a href="{{ asset('storage/profiles/'. $row->image) }}" class="hover-element position-absolute w-100 h-100" data-glightbox data-gallery="gallery">
                                                                                <i class="fa-sharp fa-solid fa-expand fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-0 p-2 lh-1"></i>
                                                                            </a>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <ul class="list-group list-group-borderless">
                                                                            <li class="list-group-item d-grid mb-3">
                                                                                ...
                                                                                <span class="fw-normal ms-1 mb-0">{{ ucwords($row->username) }}</span>
                                                                            </li>
                                                                            <li class="list-group-item d-grid mb-3">
                                                                                <span class="fw-normal h6 mb-0">Nama:</span>
                                                                                <span class="fw-normal ms-1 mb-0">{{ ucwords($row->name) }}</span>
                                                                            </li>
                                                                            <li class="list-group-item d-grid mb-3">
                                                                                <span class="fw-normal h6 mb-0">Telepon:</span>
                                                                                <span class="fw-normal ms-1 mb-0">{{ chunk_split($row['phone'], 4); }}</span>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <ul class="list-group list-group-borderless">
                                                                            <li class="list-group-item d-grid mb-3">
                                                                                ...
                                                                                <span class="fw-normal ms-1 mb-0">{!! $row->gender_label !!}</span>
                                                                            </li>
                                                                            <li class="list-group-item d-grid mb-3">
                                                                                <span class="fw-normal h6 mb-0">Alamat:</span>
                                                                                <span class="fw-normal ms-1 mb-0">{{ ucwords($row->address) }}</span>
                                                                            </li>
                                                                            <li class="list-group-item d-grid mb-3">
                                                                                <span class="fw-normal h6 mb-0">Terdaftar Pada:</span>
                                                                                <span class="fw-normal ms-1 mb-0">{{ $row->created_at->format('d F Y') }}</span>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="modal fade" id="employeeUpdateModal-{{ $row->username }}" tabindex="-1" aria-labelledby="employeeUpdateModallabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                                        <div class="modal-content border rounded-0">
                                                            <div class="modal-header border-0">
                                                                <span class="fw-normal text-center h5 mb-0">EDIT KARYAWAN</span>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form method="POST" action="{{ route('admin.employeeUpdate', $row->username) }}" enctype="multipart/form-data">
                                                                    @csrf @method('PUT')
                ...
                @if (count($employee) > 0)
                    <div class="card-footer border-top pt-2 pb-2">
                        <div class="d-flex justify-content-sm-between align-items-sm-center px-xxl-3">
                            <span class="fw-normal small mb-0">MENUNJUKKAN {{ $employee->firstItem() }} HINGGA {{ $employee->lastItem() }} DARI {{ $employee->total() }} ENTRI</span>
...
@section('modal')
    <div class="modal fade" id="employeeModal" tabindex="-1" aria-labelledby="employeeModallabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content border rounded-0">
                <div class="modal-header border-0">
                    <span class="fw-normal text-center h5 mb-0">TAMBAH KARYAWAN</span>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('admin.employeeStore') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row px-xxl-2">
                            <div class="col-12">
                                <label for="name" class="fw-medium small h6">NAMA</label>
