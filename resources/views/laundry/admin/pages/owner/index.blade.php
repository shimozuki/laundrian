    ...
    <div class="row">
        <div class="col-12 mb-4 mb-sm-5">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-dark w-100px rounded-0" data-bs-toggle="modal" data-bs-target="#ownerModal">TAMBAH</button>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card border rounded-0 h-100">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.owner') }}" class="d-flex justify-content-between mb-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-shrink table-borderless align-middle mb-0">
                            ...
                            <tbody class="border-top-0">
                                @if (count($owner) > 0)
                                    @php
                                        $pageNumber = ($owner->currentPage() - 1) * $owner->perPage();
                                    @endphp
                                            ...
                                            <td>
                                                <div class="ms-4">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end min-w-auto border rounded-0" aria-labelledby="actionDropdown">
                                                        <li class="mb-1">
                                                            <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#ownerUpdateModal-{{ $row->username }}">
                                                        ...
                                                        <li>
                                                            <form method="POST" id="delete-form-{{ $row->username }}" action="{{ route('admin.ownerDestroy', $row->username) }}">
                                                                @csrf @method('DELETE')
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                                        <div class="modal-content border rounded-0">
                                                            <div class="modal-header border-0">
                                                                <span class="fw-normal text-center h5 mb-0">RINCIAN PEMILIK</span>
                                                ...
                                                <div class="modal fade" id="ownerUpdateModal-{{ $row->username }}" tabindex="-1" aria-labelledby="ownerUpdateModallabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                                        <div class="modal-content border rounded-0">
                                                            <div class="modal-header border-0">
                                                                <span class="fw-normal text-center h5 mb-0">EDIT PEMILIK</span>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form method="POST" action="{{ route('admin.ownerUpdate', $row->username) }}" enctype="multipart/form-data">
                                                                    @csrf @method('PUT')
                ...
                @if (count($owner) > 0)
                    <div class="card-footer border-top pt-2 pb-2">
                        <div class="d-flex justify-content-sm-between align-items-sm-center px-xxl-3">
                            <span class="fw-normal small mb-0">MENUNJUKKAN {{ $owner->firstItem() }} HINGGA {{ $owner->lastItem() }} DARI {{ $owner->total() }} ENTRI</span>
...
@section('modal')
    <div class="modal fade" id="ownerModal" tabindex="-1" aria-labelledby="ownerModallabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content border rounded-0">
                <div class="modal-header border-0">
                    <span class="fw-normal text-center h5 mb-0">TAMBAH PEMILIK</span>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('admin.ownerStore') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row px-xxl-2">
                            <div class="col-12">
                                <label for="name" class="fw-medium small h6">NAMA</label>
