...
class TransactionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laundry.employee.pages.transaction.index', compact('transaction', 'customer', 'package', 'notification'));
    }
    ...
    public function transactionReceipt($invoice)
    {
        ...
        return view('laundry.employee.pages.transaction.receipt', compact('transaction'));
    }
