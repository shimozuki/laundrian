    ...
    <div class="row">
        <div class="col-12">
            <div class="card border rounded-0 h-100">
                <div class="card-body">
                    <form method="GET" action="{{ route('employee.coupon') }}" class="d-flex justify-content-between mb-3">
                                                ...
                                                <div class="ms-4">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end min-w-auto border rounded-0" aria-labelledby="actionDropdown">
                                                        @if ($row->amount == 10 && $row->status == 'not used')
                                                            <li>
                                                                <form method="POST" action="{{ route('employee.couponReceive', $row->id) }}">
                                                                    @csrf
                                                        ...
                                                        @endif
                                                        <li>
                                                            <form method="POST" id="delete-form-{{ $row->id }}" action="{{ route('employee.couponDestroy', $row->id) }}">
                                                                @csrf @method('DELETE')
