<nav class="navbar sidebar navbar-expand-xl navbar-light">
    <div class="d-flex align-items-center">
        <a href="{{ route('owner.dashboard') }}" class="navbar-brand">
    ...
    <div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
        <div class="offcanvas-body sidebar-content d-flex flex-column pt-4">
            <ul class="navbar-nav flex-column" id="navbar-sidebar">
                ...
                <li class="nav-item"> <a href="{{ route('owner.dashboard') }}" class="nav-link @yield('active-home-dashboard')">BERANDA</a> </li>
                <li class="nav-item fw-normal small ms-2 my-2"> DATA </li>
                <li class="nav-item"> <a href="{{ route('owner.report') }}" class="nav-link @yield('active-data-report')">LAPORAN</a> </li>
            </ul>
        </div>
    </div>
</nav>
