    ...
    <div class="row">
        <div class="col-12">
            <div class="card border rounded-0 h-100">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.employeeUpdate', $employee->username) }}" enctype="multipart/form-data">
                        @csrf @method('PUT')
                        <div class="row px-xxl-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-border-bottom form-control-transparent position-relative">
                                    <input type="text" name="phone" id="phone_create" class="form-control ms-3" maxlength="15" value="{{ old('phone', $employee->phone) }}" required>
                        ...
                        <div class="d-flex justify-content-center align-items-center mb-0">
                            <a href="{{ route('admin.employee') }}" class="btn btn-secondary w-50 rounded-0 mb-0 me-3">KEMBALI</a>
